...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-01-2025 a las 21:02:46
...
--
ALTER TABLE `provincias`
  ADD CONSTRAINT `provincias_ibfk_1` FOREIGN KEY (`comunidad`) REFERENCES `comunidades_autonomas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
