...
function cargarCiudades() {
    ...
    conexion1.open("GET", "https://ruizgijon.ddns.net/garciao/ajax_precipitaciones/carga_ciudadesjson.php", true);
...
function cargarAños() {
    ...
    conexion2.open("GET", "https://ruizgijon.ddns.net/garciao/ajax_precipitaciones/carga_años.php", true);
...
function cargarDatosLluvia() {
    ...
    if (idCiudad !== "0" && año !== "0") {
        conexion1 = new XMLHttpRequest();
        conexion1.open("GET", `https://ruizgijon.ddns.net/garciao/ajax_precipitaciones/carga_lluviajson.php?ciudad=${idCiudad}&anio=${año}`, true);
        conexion1.timeout = 3000;
